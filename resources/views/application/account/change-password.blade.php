...
<div class="page-section">
    <div class="container page__container">
        ...
        <form action="login" class="col-sm-5 p-0">
...
<span class="sidebar-menu-text">Chips</span>
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-change-password">
                                    <span class="sidebar-menu-text">Compact</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-change-password">
                                    <span class="sidebar-menu-text">Mini</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-secondary-change-password">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="boxed-change-password">
                                    <span class="sidebar-menu-text">Boxed</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="sticky-change-password">
