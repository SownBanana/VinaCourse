        ...
        <div class="d-flex flex-wrap align-items-center">
            ...
            <div class="flex" style="min-width: 180px">
                <small class="text-100">
                    ...
                    <strong>&dollar;9.00</strong> for invoice <a href="billing-invoice" class="text-underline">10002331</a>
                </small>
            </div>
            <a href="billing-payment" class="btn btn-sm btn-link">Pay Now</a>
        </div>
    </div>
    ...
    <div class="card table-responsive">
        <table class="table table-flush table-nowrap">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="billing-invoice" class="text-underline">10002331</a></td>
                    <td>26 Sep 2018</td>
                    <td class="text-center">&dollar;9</td>
                    <td class="text-right">
                        <div class="d-inline-flex align-items-center">
                            <a href="billing-invoice" class="btn btn-sm btn-outline-secondary mr-16pt">View invoice <i class="icon--right material-icons">keyboard_arrow_right</i></a>
                            <a href="billing-invoice" class="btn btn-sm btn-outline-secondary">Download <i class="icon--right material-icons">file_download</i></a>
                        </div>
                    </td>
                </tr>

                <tr>
                    <td><a href="billing-invoice" class="text-underline">10003815</a></td>
                    <td>29 Apr 2018</td>
                    <td class="text-center">&dollar;9</td>
                    <td class="text-right">
                        <div class="d-inline-flex align-items-center">
                ...
                <tr>
                    <td><a href="billing-invoice" class="text-underline">10007382</a></td>
                    <td>31 Mar 2018</td>
                    <td class="text-center">&dollar;9</td>
                    <td class="text-right">
                        <div class="d-inline-flex align-items-center">
                ...
                <tr>
                    <td><a href="billing-invoice" class="text-underline">10004876</a></td>
                    <td>30 May 2018</td>
                    <td class="text-center">&dollar;9</td>
                    <td class="text-right">
                        <div class="d-inline-flex align-items-center">
                ...
                <tr>
                    <td><a href="billing-invoice" class="text-underline">10009392</a></td>
                    <td>30 Apr 2018</td>
                    <td class="text-center">&dollar;9</td>
                    <td class="text-right">
                        <div class="d-inline-flex align-items-center">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="compact-billing-payment">
                                <span class="sidebar-menu-text">Compact</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-billing-payment">
                                <span class="sidebar-menu-text">Mini</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-secondary-billing-payment">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="boxed-billing-payment">
                                <span class="sidebar-menu-text">Boxed</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="sticky-billing-payment">
