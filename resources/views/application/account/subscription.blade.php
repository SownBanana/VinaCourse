...
<div class="page-section container page__container">
    <div class="page-separator">
        <div class="page-separator__text">Subscription</div>
    </div>
        ...
        <div class="list-group list-group-form">
            <div class="list-group-item">
                <div class="form-group row align-items-center mb-0">
                    ...
                    <div class="col-sm-9 d-flex align-items-center">
                        ...
                        <a href="billing-upgrade" class="text-secondary">Change plan</a>
                    </div>
                </div>
            </div>
            <div class="list-group-item">
            ...
            <div class="list-group-item">
                <div class="form-group row align-items-center mb-0">
                    ...
                    <div class="col-sm-9 d-flex align-items-center">
                        <img src="assets/images/visa.svg" alt="visa" width="38" class="mr-16pt">
                        <div class="flex">Visa ending with 2819</div>
                        <a href="billing-payment" class="text-secondary">Change method</a>
                    </div>
                </div>
            </div>
            <div class="list-group-item">
...
<span class="sidebar-menu-text">Chips</span>
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="compact-billing">
                                <span class="sidebar-menu-text">Compact</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-billing">
                                <span class="sidebar-menu-text">Mini</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-secondary-billing">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="boxed-billing">
                                <span class="sidebar-menu-text">Boxed</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="sticky-billing">
