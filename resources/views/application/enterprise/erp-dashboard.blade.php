                            ...
                            <div class="col-auto">
                                <div class="p-card-header d-flex align-items-center">
                                    ...
                                    <div class="flex">
                                        ...
                                        <p class="card-subtitle text-50">This week</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto border-left">
                                <div class="p-card-header d-flex align-items-center">
                                    ...
                                    <div class="flex">
                                        ...
                                        <p class="card-subtitle text-50">Bank account</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                        ...
                        <div class="row no-gutters flex" role="tablist">
                            <div class="col-auto">
                                <div class="p-card-header d-flex align-items-center">
                                    ...
                                    <div class="flex">
                                        <p class="card-title mb-4pt">Income</p>
                            ...
                            <div class="col-auto">
                                <div class="p-card-header d-flex align-items-center">
                                    ...
                                    <div class="flex">
                                        <p class="card-title mb-4pt">Expense</p>
                                        <p class="text-50 mb-0 d-flex align-items-center">
                    ...
                    <div class="card-body position-relative o-hidden p-0">
                        <div class="chart z-0" style="height: 110px;">
                            <canvas id="viewsChart" class="chart-canvas js-update-chart-line-2nd-accent" data-chart-line-border-color="primary,gray" data-chart-suffix=" views" data-chart-hide-axes="true"></canvas>
                        </div>
                    </div>
                </div>
