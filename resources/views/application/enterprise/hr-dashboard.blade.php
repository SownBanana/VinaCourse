                            ...
                            <div class="card-body">
                                <div class="text-50 mb-16pt">
                                    ...
                                    <div class="mb-4pt">
                                        ...
                                        <div class="progress" style="height: 4px;">
                                            <div class="progress-bar bg-accent" role="progressbar" style="width: 22%;" aria-valuenow="22" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center">
                                    <a href="" class="btn btn-sm btn-outline-secondary">View employees</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="" class="btn btn-sm btn-outline-secondary">View departments</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-center" style="white-space: nowrap;">
                                ...
                                <div class="flex ml-4pt">
                                    <div class="d-flex flex-column">
                                        ...
                                        <small class="text-50">paolo.zieme@gmail.com</small>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="chart" style="height: 262px;">
                                    ...
                                    <canvas class="chart-canvas position-relative z-1" id="attendanceDoughnutChart" data-chart-legend="#attendanceDoughnutChartLegend" data-chart-line-background-color="primary;accent;gray.700;gray">
