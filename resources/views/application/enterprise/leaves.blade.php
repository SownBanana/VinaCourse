                ...
                <table class="table mb-0 thead-border-top-0 table-nowrap">
                    ...
                    <tbody class="list" id="leaves">
                        ...
                        <tr>
                            ...
                            <td class="pr-0">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input js-check-selected-row" id="customCheck1_leaves2">
                                    <label class="custom-control-label" for="customCheck1_leaves2"><span class="text-hide">Check</span></label>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="pr-0">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input js-check-selected-row" id="customCheck1_leaves3">
                                    <label class="custom-control-label" for="customCheck1_leaves3"><span class="text-hide">Check</span></label>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="pr-0">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input js-check-selected-row" id="customCheck1_leaves4">
                                    <label class="custom-control-label" for="customCheck1_leaves4"><span class="text-hide">Check</span></label>
                                </div>
                            </td>
                        ...
                        <tr class="selected">
                            ...
                            <td class="pr-0">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input js-check-selected-row" checked="" id="customCheck1_leaves5">
                                    <label class="custom-control-label" for="customCheck1_leaves5"><span class="text-hide">Check</span></label>
                                </div>
                            </td>
...
15 <span class="text-50">of 1,430</span> <a href="#" class="text-50"><i class="material-icons ml-1">arrow_forward</i></a>
        ...
        <div class="page-separator">
            <div class="page-separator__text">Leave request</div>
        </div>
        ...
        <div class="row">
                ...
                <div class="card mb-lg-0">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" data-toggle="flatpickr" data-flatpickr-mode="range" data-flatpickr-inline="true" value="2020-01-09 to 2020-01-17">
                        </div>
                        <div class="alert alert-soft-warning mb-0 p-8pt">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex">
                                    <small class="text-100">On <strong>January 9</strong>, there’s a shortage of iOS Developers.</small>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <form>
                    ...
                    <p>You’ve selected <strong>January 9 - 17</strong>. That’s a total of <strong>7 working days</strong> spanning over <strong>9 days</strong>.</p>

                    <p class="d-flex align-items-center">
                        <i class="material-icons text-accent mr-8pt">check_circle</i>
                        <small>You’re within your <strong>Anual Leave</strong> quota, which will reduce to <strong>15 days</strong>.</small>
                    </p>
