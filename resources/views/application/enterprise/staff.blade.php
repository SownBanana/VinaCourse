...
<div class="pt-32pt">
    <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
        ...
        <div class="row" role="tablist">
            <div class="col-auto">
                <a href="" class="btn btn-outline-secondary">Add Staff</a>
            </div>
        </div>
...
<div class="container page__container page__container page-section">
            ...
            <div class="card card-group-row__card p-relative o-hidden">
                <div class="card-body d-flex flex-row align-items-center">
                    <div class="flex">
                        ...
                        <span class="h2 m-0">&dollar;24k</span>
                    </div>
            ...
            <div class="card card-group-row__card p-relative o-hidden">
                <div class="card-body d-flex flex-row align-items-center">
                    <div class="flex">
                        ...
                        <span class="h2 m-0">&dollar;50k</span>
                    </div>
            ...
            <div class="card card-group-row__card">
                <div class="card-body d-flex flex-row align-items-center">
                    <div class="card-title flex">
                        <strong>Top Grossing</strong>
                        <div class="h2 m-0">&dollar;13k</div>
                    </div>
    ...
    <div class="card mb-lg-32pt">
        ...
        <div class="card-body">
            ...
            <div class="chart">
                <canvas id="ordersChart" class="chart-canvas js-update-chart-bar" data-chart-legend="#ordersChartLegend" data-chart-prefix="$" data-chart-suffix="k" data-chart-line-background-color="primary"></canvas>
            </div>
        </div>
    </div>
            ...
            <table class="table mb-0 thead-border-top-0 table-nowrap">
                ...
                <tbody class="list" id="staff">
                    ...
                    <tr>
                        ...
                        <td class="pr-0">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input js-check-selected-row" id="customCheck1_staff2">
                                <label class="custom-control-label" for="customCheck1_staff2"><span class="text-hide">Check</span></label>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="pr-0">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input js-check-selected-row" id="customCheck1_staff3">
                                <label class="custom-control-label" for="customCheck1_staff3"><span class="text-hide">Check</span></label>
                            </div>
                        </td>
                    ...
                    <tr class="selected">
                        ...
                        <td class="pr-0">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input js-check-selected-row" checked="" id="customCheck1_staff4">
                                <label class="custom-control-label" for="customCheck1_staff4"><span class="text-hide">Check</span></label>
                            </div>
                        </td>
