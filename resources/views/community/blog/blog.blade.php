...
<div class="page-section bg-body border-bottom-2">
    <div class="container page__container">
        ...
        <div class="text-center d-flex align-items-center flex-wrap mb-32pt" style="white-space: nowrap;">
            ...
            <a href="" class="chip mb-16pt mb-md-0 chip-secondary">Design</a>
            <a href="" class="chip mb-16pt mb-md-0 chip-outline-secondary">Development</a>
            <a href="" class="chip mb-16pt mb-md-0 chip-outline-secondary">Photography</a>
            <a href="" class="chip mb-16pt mb-md-0 chip-outline-secondary d-md-none d-lg-inline-flex">Business</a>
        </div>
                ...
                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                    ...
                    <div class="posts-card-popular__content">
                        ...
                        <div class="posts-card-popular__title card-body">
                            ...
                            <a class="card-title" href="blog-post">Merge Duplicates Inconsistent Symbols</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                    ...
                    <div class="posts-card-popular__content">
                        ...
                        <div class="posts-card-popular__title card-body">
                            ...
                            <a class="card-title" href="blog-post">Design Systems Essentials</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card--elevated posts-card-popular overlay card-group-row__card">
                    ...
                    <div class="posts-card-popular__content">
                        ...
                        <div class="posts-card-popular__title card-body">
                            ...
                            <a class="card-title" href="blog-post">Semantic Logo Design</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                ...
                <div class="mb-24pt">
                    ...
                    <div class="card posts-card posts-card--wrap-xl">
                        <div class="posts-card__content d-flex align-items-center flex-wrap">
                            <div class="avatar avatar-lg overlay overlay--primary rounded o-hidden mr-3">
                                <a href="blog-post"><img src="assets/images/paths/photoshop_200x168.png" alt="avatar" class="avatar-img rounded"></a>
                                <div class="overlay__content"></div>
                            </div>
                            <div class="posts-card__title flex d-flex flex-column">
                                <a href="blog-post" class="card-title mr-3">Semantic Logo Design</a>
                    ...
                    <div class="card posts-card posts-card--wrap-xl">
                        <div class="posts-card__content d-flex align-items-center flex-wrap">
                            <div class="avatar avatar-lg overlay overlay--primary rounded o-hidden mr-3">
                                <a href="blog-post"><img src="assets/images/paths/invision_200x168.png" alt="avatar" class="avatar-img rounded"></a>
                                <div class="overlay__content"></div>
                            </div>
                            <div class="posts-card__title flex d-flex flex-column">
                                <a href="blog-post" class="card-title mr-3">Design Systems Essentials</a>
                    ...
                    <div class="card posts-card posts-card--wrap-xl">
                        <div class="posts-card__content d-flex align-items-center flex-wrap">
                            <div class="avatar avatar-lg overlay overlay--primary rounded o-hidden mr-3">
                                <a href="blog-post"><img src="assets/images/paths/sketch_200x168.png" alt="avatar" class="avatar-img rounded"></a>
                                <div class="overlay__content"></div>
                            </div>
                            <div class="posts-card__title flex d-flex flex-column">
                                <a href="blog-post" class="card-title mr-3">Merge Duplicates Inconsistent Symbols &amp; Styles</a>
                                <small class="text-50">78 views last week</small>
                            </div>
                            <div class="d-flex align-items-center flex-column flex-sm-row posts-card__meta">
                                <div class="mr-3 text-50 text-uppercase posts-card__tag d-flex align-items-center">
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-8pt d-flex align-items-center">
                    <a href="blog-post" class="avatar avatar-lg overlay overlay--primary mr-12pt">
                        <img src="assets/images/paths/invision_200x168.png" alt="assets/images/paths/invision_200x168.png" class="avatar-img rounded">
                        <span class="overlay__content"></span>
                    </a>
                    <div class="flex">
                        <a class="card-title mb-4pt" href="blog-post">Design Systems Essentials</a>
                        <div class="d-flex align-items-center">
                            <small class="text-muted mr-8pt"><a href="">inVision</a></small>
                ...
                <div class="mb-8pt d-flex align-items-center">
                    <a href="blog-post" class="avatar avatar-lg overlay overlay--primary mr-12pt">
                        <img src="assets/images/paths/photoshop_200x168.png" alt="assets/images/paths/photoshop_200x168.png" class="avatar-img rounded">
                        <span class="overlay__content"></span>
                    </a>
                    <div class="flex">
                        <a class="card-title mb-4pt" href="blog-post">Semantic Logo Design</a>
                        <div class="d-flex align-items-center">
                            <small class="text-muted mr-8pt"><a href="">Photoshop</a></small>
                ...
                <div class="mb-0 d-flex align-items-center">
                    <a href="blog-post" class="avatar avatar-lg overlay overlay--primary mr-12pt">
                        <img src="assets/images/paths/sketch_200x168.png" alt="assets/images/paths/sketch_200x168.png" class="avatar-img rounded">
                        <span class="overlay__content"></span>
                    </a>
                    <div class="flex">
                        <a class="card-title mb-4pt" href="blog-post">Merge Duplicates Inconsistent Symbols &amp; Styles</a>
                        <div class="d-flex align-items-center">
                            <small class="text-muted mr-8pt"><a href="">Sketch</a></small>
                            <small class="text-muted mr-8pt">78 Views</small>
...
<span class="sidebar-menu-text">Chips</span>
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="compact-blog">
                                <span class="sidebar-menu-text">Compact</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-blog">
                                <span class="sidebar-menu-text">Mini</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-secondary-blog">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="boxed-blog">
                                <span class="sidebar-menu-text">Boxed</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="sticky-blog">
