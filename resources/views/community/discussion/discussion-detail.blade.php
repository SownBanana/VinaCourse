        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <p class="text-muted d-flex align-items-center mb-lg-32pt">
                    <a href="discussions" class="mr-3">Back to Community</a>
                ...
                <div class="card card-body">
                    <div class="d-flex">
                        <a href="" class="avatar avatar-sm avatar-online mr-12pt">
                            <!-- <img src="assets/images/people/256/256_rsz_nicolas-horn-689011-unsplash.jpg" alt="people" class="avatar-img rounded-circle"> -->
            ...
            <div class="col-md-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="" class="avatar avatar-xs mr-8pt">
                            <img src="assets/images/people/256/256_rsz_nicolas-horn-689011-unsplash.jpg" alt="course" class="avatar-img rounded-circle">
                        </a>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="" class="avatar avatar-xs mr-8pt">
                            <img src="assets/images/people/256/256_rsz_sharina-mae-agellon-377466-unsplash.jpg" alt="course" class="avatar-img rounded-circle">
                        </a>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="" class="avatar avatar-xs mr-8pt">
                            <img src="assets/images/people/256/256_rsz_karl-s-973833-unsplash.jpg" alt="course" class="avatar-img rounded-circle">
                        </a>
...
<span class="sidebar-menu-text">Chips</span>
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="compact-discussion">
                                <span class="sidebar-menu-text">Compact</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-discussion">
                                <span class="sidebar-menu-text">Mini</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="mini-secondary-discussion">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="boxed-discussion">
                                <span class="sidebar-menu-text">Boxed</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="sticky-discussion">
