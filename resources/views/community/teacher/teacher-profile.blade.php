        ...
        <div class="col-sm-6 card-group-row__col">
            <div class="card card-sm card-group-row__card">
                <div class="card-body d-flex align-items-center">
                    <a href="course" class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
        ...
        <div class="col-sm-6 card-group-row__col">
            <div class="card card-sm card-group-row__card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex">
                        <a class="card-title mb-4pt" href="course">Introduction to TypeScript</a>
                        <div class="d-flex align-items-center">
                            <div class="rating mr-8pt">
        ...
        <div class="col-sm-6 card-group-row__col">
            <div class="card card-sm card-group-row__card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex">
                        <a class="card-title mb-4pt" href="course">Learn Angular Fundamentals</a>
                        <div class="d-flex align-items-center">
                            <div class="rating mr-8pt">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-teacher-profile">
                                    <span class="sidebar-menu-text">Compact</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-teacher-profile">
                                    <span class="sidebar-menu-text">Mini</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-secondary-teacher-profile">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="boxed-teacher-profile">
                                    <span class="sidebar-menu-text">Boxed</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="sticky-teacher-profile">
