...
<div class="pt-32pt">
    <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
        ...
        <div class="row" role="tablist">
            <div class="col-auto">
                <a href="instructor-edit-quiz" class="btn btn-outline-secondary">Add Quiz</a>
            </div>
        </div>
        ...
        <div class="card-group-row__col col-md-6">
            <div class="card card-group-row__card card-sm">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex">
                        <a class="card-title" href="instructor-edit-quiz">Angular Routing In-Depth</a>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="instructor-edit-quiz" class="dropdown-item">Edit Quiz</a>
        ...
        <div class="card-group-row__col col-md-6">
            <div class="card card-group-row__card card-sm">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex">
                        <a class="card-title" href="instructor-edit-quiz">Angular Unit Testing</a>
                        <div class="card-subtitle text-50">15 completed</div>
                    </div>
                </div>
                <div class="card-footer">
        ...
        <div class="card-group-row__col col-md-6">
            <div class="card card-group-row__card card-sm">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex">
                        <a class="card-title" href="instructor-edit-quiz">Introduction to TypeScript</a>
                        <div class="card-subtitle text-50">15 completed</div>
                    </div>
                </div>
                <div class="card-footer">
        ...
        <div class="card-group-row__col col-md-6">
            <div class="card card-group-row__card card-sm">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex">
                        <a class="card-title" href="instructor-edit-quiz">Angular Fundamentals</a>
                        <div class="card-subtitle text-50">15 completed</div>
                    </div>
                </div>
                <div class="card-footer">
        ...
        <div class="list-group list-group-flush">
            ...
            <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                    ...
                    <div class="flex">
                        <a class="card-title mb-4pt" href="instructor-edit-quiz">Newsletter Design</a>
                    </div>
                </div>
                <div class="d-flex align-items-center">
            ...
            <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                    ...
                    <div class="flex">
                        <a class="card-title mb-4pt" href="instructor-edit-quiz">Adobe XD</a>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <div class="flex text-center d-flex align-items-center mr-16pt">
            ...
            <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                    ...
                    <div class="flex">
                        <a class="card-title mb-4pt" href="instructor-edit-quiz">inVision App</a>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <div class="flex text-center d-flex align-items-center mr-16pt">
            ...
            <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                    ...
                    <div class="flex">
                        <a class="card-title mb-4pt" href="instructor-edit-quiz">Craft by inVision</a>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <div class="flex text-center d-flex align-items-center mr-16pt">
