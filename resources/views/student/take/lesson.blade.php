            ...
            <div class="nav-item py-16pt py-sm-0">
                <div class="media flex-nowrap">
                    ...
                    <div class="media-body d-flex flex-column">
                        <a href="student-take-course" class="card-title">Angular Fundamentals</a>
                        <div class="d-flex">
...
<div class="bg-primary pb-lg-64pt py-32pt">
    <div class="container page__container">
        <nav class="course-nav">
            ...
            <a data-toggle="tooltip" data-placement="bottom" data-title="Quiz: Getting Started with Angular" href="student-take-quiz"><span class="material-icons">hourglass_empty</span></a>
        </nav>
...
<div class="page-section">
    <div class="container page__container">
        ...
        <div class="d-flex align-items-center mb-heading">
            ...
            <a href="discussions-ask" class="text-underline ml-auto">Ask a Question</a>
        </div>
        ...
        <a href="discussions" class="btn btn-outline-secondary">See all discussions for this lesson</a>
